    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                .authorizeRequests(authorize -> authorize
                        .requestMatchers("/userRegistration", "/userRegistration/save", "/userRegistration/**",
                                "/index", "/css/**", "/images/**", "/js/**").permitAll()
                        .requestMatchers("/login").permitAll()
                        .requestMatchers("/patientDashboard","/appointmentList").hasRole("PATIENT")
                        .requestMatchers("/adminDashboard","/registeredUsers").hasRole("ADMIN")
